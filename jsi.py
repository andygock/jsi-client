...
import sys
import urllib, urllib2, xmltodict, json, argparse
...
if __name__ == "__main__":
    ...
    parser.add_argument("--magnet", help="magnet link", type=str, nargs=1)
    parser.add_argument("--torrent-file", type=str, help='add single torrent file')
    parser.add_argument("--list", action='store_true', help='list torrents')
    ...
    parser.add_argument("--pause", action='store_true', help='pause when finished')
    parser.add_argument("--ratio", type=float, help='set ratio')
